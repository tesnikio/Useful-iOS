...
+ (void)swizzleClassMethodOfClass:(Class)targetClass currentSelector:(SEL)currentSelector newSelector:(SEL)newSelector {
    ...
    targetClass = object_getClass((instancetype)targetClass);
...
- (void)setAssociatedObject:(instancetype)object forKey:(void const *)key
{
    [self setAssociatedObject:object forKey:key associationPolicy:NSObjectAssociationPolicyRetain];
}

- (void)setAssociatedObject:(instancetype)object forKey:(void const *)key associationPolicy:(NSObjectAssociationPolicy)associationPolicy {
    int policy = 0;
...
- (instancetype)associatedObjectForKey:(void const *)key {
